...
public class PlayerMovement : MonoBehaviour {
    ...
    public bool BlockLeftMovement { get; private set; } = false;
    public bool BlockRightMovement { get; private set; } = false;
    ...
    private void Update() {
        ...
        if (!_isDashAttacking) {
            ...
            if (IsSliding) {
                ...
                RB.velocity = new Vector2(RB.velocity.x, Mathf.Max(RB.velocity.y, -0/*Data.maxFastFallSpeed*/));
            }
            else if (_isJumpCut) {
    ...
    private void Turn() {
        ...
        //Debug.Log("Is right = " + IsFacingRight + " Anim = " + GetComponent<SpriteRenderer>().flipX);
    }
    #endregion
